...
export const homeCopy = {
  en: {
    ...
    cravingChapters: "19 craving chapters",
    ...
    whereAnswer: "Find us at 126, The Mall Road, Mirpur, Kanpur, Uttar Pradesh 208004. The restaurant is opposite Mega Mall on Mall Road, making it straightforward to locate before you set out.",
    vegetarian: "Is the menu vegetarian?",
    vegetarianAnswer: "Yes. The restaurant presents a vegetarian multi-cuisine menu, with everything from South Indian favourites and pizza to Chinese dishes, snacks, shakes, desserts, and ice cream.",
    browse: "What time does the restaurant open?",
    browseAnswer: "We are open Monday to Sunday, 11 AM to 11 PM. These are the standard daily hours shown across the site, so you can plan a meal, a dessert stop, or an evening visit with confidence.",
    order: "Can I order or reserve from this website?",
    orderAnswer: "For reservations or order enquiries, please call the restaurant directly. The team can help with the most current details for your visit and answer any questions about the menu before you come in.",
    directionsQuestion: "When does the restaurant open?",
    directionsAnswer: "Naatures Scuup is open every day, Monday to Sunday, from 11 AM to 11 PM. Hours are shown throughout this website for quick reference; please call the restaurant directly if you need to confirm a visit around a holiday or special occasion.",
  },
  hi: {
    ...
    cravingChapters: "19 स्वाद अध्याय",
    ...
    whereAnswer: "हमारा पता है: 126, द मॉल रोड, मिरपुर, कानपुर, उत्तर प्रदेश 208004। रेस्टोरेंट मॉल रोड पर मेगा मॉल के सामने है, इसलिए निकलने से पहले इसे ढूँढना आसान रहता है।",
    vegetarian: "क्या मेनू शाकाहारी है?",
    vegetarianAnswer: "हाँ। रेस्टोरेंट में शाकाहारी मल्टी-कुज़ीन मेनू उपलब्ध है, जिसमें साउथ इंडियन फेवरेट्स, पिज़्ज़ा, चाइनीज़ डिशेज़, स्नैक्स, शेक्स, डेज़र्ट्स और आइसक्रीम शामिल हैं।",
    browse: "रेस्टोरेंट कितने बजे खुलता है?",
    browseAnswer: "हम सोमवार से रविवार, सुबह 11 बजे से रात 11 बजे तक खुले रहते हैं। यही साइट पर दिए गए रोज़ के सामान्य घंटे हैं, ताकि आप भोजन, डेज़र्ट या शाम की विज़िट आसानी से प्लान कर सकें।",
    order: "क्या मैं इस वेबसाइट से ऑर्डर या रिज़र्व कर सकता/सकती हूँ?",
    orderAnswer: "रिज़र्वेशन या ऑर्डर संबंधी जानकारी के लिए कृपया सीधे रेस्टोरेंट को कॉल करें। टीम आपकी विज़िट के लिए मौजूदा जानकारी साझा कर सकती है और आने से पहले मेनू से जुड़े सवालों का जवाब दे सकती है।",
    directionsQuestion: "रेस्टोरेंट कब खुलता है?",
    directionsAnswer: "नेचर्स स्कूप हर दिन, सोमवार से रविवार, सुबह 11 बजे से रात 11 बजे तक खुला रहता है। आसानी से देखने के लिए समय इस वेबसाइट पर दिया गया है; छुट्टी या किसी खास अवसर के आसपास आने से पहले पुष्टि के लिए सीधे रेस्टोरेंट को कॉल करें।",
  },
} as const;
...
export const menuCopy = {
  en: {
    ...
    chapterHours: "19 chapters · 231 dishes · Mon-Sun, 11 AM to 11 PM",
  ...
  hi: {
    ...
    chapterHours: "19 अध्याय · 231 डिश · सोम-रवि, सुबह 11 बजे से रात 11 बजे तक",
...
const hindiChapterNotes: Record<string, string> = {
  ...
  "live-ice-creams": "काउंटर पर बनाया गया",
  extras: "थोड़ा और",
};
...
export const cinematicCopy = {
  en: {
    videoLabel: "Mango ice-cream sequence", originKicker: "The Mall · Kanpur", originMobile: "Kanpur's first|live scoop.", originCopy: "Kanpur's first live ice-cream parlour, one fresh scoop at a time.", liveIceCream: "Live ice cream", vegetarianDining: "Vegetarian dining", parlourKicker: "Mall Road, Kanpur", parlourDesktop: "Kanpur's first|live ice-cream|parlour", parlourMobile: "Made cold.|Made live.", parlourCopy: "Watch the cold come alive, live in the restaurant.", cravingKicker: "Made for the table", cravingDesktop: "One place.|Every craving.", cravingMobile: "One table.|Every craving.", cravingCopy: "From the first bite to the final frozen spoonful.", varietyKicker: "More at the table", varietyDesktop: "Dosas to desserts.|Find your craving.", varietyMobile: "Dosas to desserts.|Find your craving.", varietyCopy: "From dosa to desserts, one table holds every craving.", endKicker: "Keep it cold", endDesktop: "#FREEZE THE|HAPPINESS", endMobile: "#FREEZE THE|HAPPINESS", endHashtagAria: "#FREEZETHEHAPPINESS", endCopy: "The Naatures Scuup way.", closingStamp: "Keep the happiness cold", checkpointPrompt: "Scroll to unfreeze", scrollPrompt: "Scroll!", nextStory: "Scroll to the next part of the story", continue: "Scroll down to continue", preparing: "Preparing the image sequence",
  },
  hi: {
    videoLabel: "मैंगो आइसक्रीम सीक्वेंस", originKicker: "द मॉल · कानपुर", originMobile: "कानपुर का पहला|लाइव स्कूप।", originCopy: "कानपुर का पहला लाइव आइसक्रीम पार्लर, हर बार एक ताज़ा स्कूप।", liveIceCream: "लाइव आइसक्रीम", vegetarianDining: "शाकाहारी भोजन", parlourKicker: "मॉल रोड, कानपुर", parlourDesktop: "कानपुर का पहला|लाइव आइसक्रीम|पार्लर", parlourMobile: "ठंडा बना।|लाइव बना।", parlourCopy: "ठंडक को रेस्टोरेंट में जीवंत होते देखें।", cravingKicker: "टेबल के लिए बना", cravingDesktop: "एक जगह।|हर क्रेविंग।", cravingMobile: "एक टेबल।|हर क्रेविंग।", cravingCopy: "पहले निवाले से आखिरी ठंडे चम्मच तक।", varietyKicker: "टेबल पर और भी", varietyDesktop: "डोसा से डेज़र्ट तक।|अपनी क्रेविंग चुनें।", varietyMobile: "डोसा से डेज़र्ट तक।|अपनी क्रेविंग चुनें।", varietyCopy: "डोसा से डेज़र्ट तक, एक टेबल हर क्रेविंग को जगह देता है।", endKicker: "ठंडा रखें", endDesktop: "#FREEZE THE|HAPPINESS", endMobile: "#FREEZE THE|HAPPINESS", endHashtagAria: "#FREEZETHEHAPPINESS", endCopy: "नेचर्स स्कूप का तरीका।", closingStamp: "खुशी को ठंडा रखें", checkpointPrompt: "ठंडक खोलने के लिए स्क्रॉल करें", scrollPrompt: "स्क्रॉल!", nextStory: "कहानी के अगले हिस्से तक स्क्रॉल करें", continue: "आगे बढ़ने के लिए नीचे स्क्रॉल करें", preparing: "सीक्वेंस तैयार किया जा रहा है",
  },
} as const;
