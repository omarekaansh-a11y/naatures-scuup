...
export function MobileVisitDock() {
  return <nav className="mobile-visit-dock" aria-label="Visit Naatures Scuup"><Link href="/menu">Full menu</Link><a href={mapUrl} target="_blank" rel="noreferrer">Directions <MapPin size={14} /></a></nav>;
}
