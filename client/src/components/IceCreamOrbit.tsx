...
const sequenceStyles = `
  ...
  @media(max-width:767px){.ice-orbit__video{object-fit:cover}.ice-orbit__story{padding-inline:max(1rem,env(safe-area-inset-left)) max(1rem,env(safe-area-inset-right))}.ice-orbit__story-card{box-sizing:border-box;width:clamp(8.75rem,40vw,15rem);max-width:calc(50vw - 1.5rem);text-wrap:pretty}.ice-orbit__story-card--origin{top:clamp(4.5rem,16svh,8.5rem);left:max(1rem,env(safe-area-inset-left));text-align:left}.ice-orbit__story-card--left{top:clamp(6rem,25svh,12.5rem);left:max(1rem,env(safe-area-inset-left));text-align:left}.ice-orbit__story-card--right{top:clamp(5rem,20svh,10rem);right:max(1rem,env(safe-area-inset-right));text-align:right}.ice-orbit__story-card--end{right:max(1rem,env(safe-area-inset-right));bottom:max(3.5rem,14svh,env(safe-area-inset-bottom));left:auto;text-align:right}.ice-orbit__story-title{font-size:clamp(1.2rem,6.4vw,2.25rem);line-height:.94;letter-spacing:-.055em}.ice-orbit__story-card--origin .ice-orbit__story-title{font-size:clamp(1.45rem,7.2vw,2.55rem)}.ice-orbit__story-card--end .ice-orbit__story-title{font-size:clamp(1.25rem,6.6vw,2.35rem)}.ice-orbit__story-kicker{gap:.45rem;margin-bottom:.65rem;font-size:clamp(.42rem,1.8vw,.54rem);letter-spacing:.16em}.ice-orbit__story-kicker::before{width:1.15rem}.ice-orbit__story-copy{max-width:100%;margin-top:.75rem;font-size:clamp(.58rem,2.15vw,.68rem);line-height:1.45;letter-spacing:.025em}}
