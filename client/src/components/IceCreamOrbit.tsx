...
const sequenceStyles = `
  ...
  @media(max-width:767px){.ice-orbit__story-card--origin,.ice-orbit__story-card--left,.ice-orbit__story-card--right,.ice-orbit__story-card--end{top:49%!important;right:auto!important;bottom:auto!important;left:50%!important;width:min(14rem,62vw)!important;text-align:center!important}.ice-orbit__story-card--origin[data-active="true"]{transform:translate3d(-50%,0,48px) rotateX(5deg) rotateY(-3deg)!important}.ice-orbit__story-card--left[data-active="true"]{transform:translate3d(-50%,0,50px) rotateX(4deg) rotateY(4deg)!important}.ice-orbit__story-card--right[data-active="true"]{transform:translate3d(-50%,0,52px) rotateX(5deg) rotateY(-5deg)!important}.ice-orbit__story-card--end[data-active="true"]{transform:translate3d(-50%,0,46px) rotateX(4deg) rotateY(3deg)!important}.ice-orbit__story-card--left .ice-orbit__story-kicker,.ice-orbit__story-card--right .ice-orbit__story-kicker{justify-content:center!important}.ice-orbit__story-card--left .ice-orbit__story-copy,.ice-orbit__story-card--right .ice-orbit__story-copy{margin-right:auto!important;margin-left:auto!important}}
