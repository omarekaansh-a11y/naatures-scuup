...
const dishNotes: Record<string, string> = {
  ...
  "Spicy Lemonade":"Refreshing lemonade with a tangy twist.","Virgin Mojito":"Bright and refreshing mojito.","Kiwi Blast":"Cool kiwi-forward mocktail.","Blue Lagoon":"Bright, refreshing fruit-style drink.","Oreo Mud Shake":"Oreo, milk and chocolate blended creamy.","Kit Kat Break Shake":"Crunchy chocolate shake.","Ferro Rocher Shake":"Decadent shake with Ferrero Rocher.","Cold Coffee with Vanilla Ice Cream":"Cool creamy coffee with vanilla ice cream.","Khasta Roti":"Crisp tandoor-style roti for the table.","Tawa Roti":"A simple tawa-made roti.","Tawa Butter Roti":"Tawa roti finished with butter.","Strawberry Pulp Ice Cream":"Strawberry-forward ice cream with a fruity finish.","Banana Bonanza Ice Cream":"Creamy banana ice cream for a sweet finish.","Sapota Chikoo Ice Cream":"Creamy chikoo ice cream with a mellow fruit note.","Blue Bubblegum Ice Cream":"Blue bubblegum ice cream with a playful sweet flavour.","Strawberry Cheese Ice Cream":"Strawberry and cheese-inspired ice cream.","Black Grapes Ice Cream":"Grape-forward ice cream with a bright fruit finish.","Mint Ice Cream":"Cool mint ice cream for a fresh finish.","Toblerene Shake":"Chocolate-inspired shake.","M & M Shake":"Chocolate candy-inspired shake.","Canelle":"A chilled mocktail-style drink.","Poppins":"A bright, refreshing drink.","Grenadine Mix":"A sweet, fruit-forward mocktail.","Oreo Live Ice Cream":"Live ice cream made with Oreo.","Kit Kat Live Ice Cream":"Live ice cream made with Kit Kat.","Brownie Live Ice Cream":"Live ice cream made with brownie.","Choco Lava Live Ice Cream":"Live ice cream with a choco lava profile.","Strawberry Live Ice Cream":"Fresh strawberry live ice cream.","Mango Live Ice Cream":"Fresh mango live ice cream.","Banana Live Ice Cream":"Fresh banana live ice cream.","Cakes":"On-request baked sweet selection.","Pastries":"On-request bakery selection.","Swiss Roll":"On-request baked roll.","Extra Cheese Dip":"A bowl of extra cheese dip.","Extra Cheese for Pizza":"Extra cheese for your pizza."
};

const chapterArtwork: Record<string, { src: string; alt: string; position: string }> = {
  "starters": { src: "/site-media/starters_52361bda.jpg", alt: "Crisp vegetarian samosas and chutney for the Starters chapter", position: "center 54%" },
  "soups-salads": { src: "/site-media/soups-salads_54760609.jpg", alt: "Fresh salad and soup ingredients in a textured restaurant setting", position: "center" },
  "main-course": { src: "/site-media/main-course_a81f2fd4.jpg", alt: "Paneer curry and naan for the Main Course chapter", position: "center 56%" },
  "breads": { src: "/site-media/breads_6f562564.jpg", alt: "Paneer curry with naan for the Breads chapter", position: "center 54%" },
  "rice-biryani": { src: "/site-media/rice-biryani_7c85671b.jpg", alt: "Vegetable biryani for the Rice & Biryani chapter", position: "center 56%" },
  "south-indian": { src: "/site-media/south-indian_12355c34.jpg", alt: "Crisp dosa with chutneys for the South Indian chapter", position: "center 52%" },
  "chinese": { src: "/site-media/chinese-noodles-manchurian-chapter_630f21ae.jpg", alt: "Vegetable Hakka noodles lifted by chopsticks with Manchurian for the Chinese chapter", position: "center 52%" },
  "fried-rice-noodles": { src: "/site-media/fried-rice-noodles_6033e44e.webp", alt: "Wok-tossed vegetable noodles for the Fried Rice & Noodles chapter", position: "center 52%" },
  "pizza-pasta": { src: "/manus-storage/pizza-and-pasta-chapter-hd_5aadedcb_04d0d487.png", alt: "High-resolution pizza from Naatures Scuup for the Pizza & Pasta chapter", position: "center 55%" },
  "burgers-sandwiches": { src: "/site-media/vegetarian-burger-chapter_b21738a3.jpg", alt: "A stacked vegetarian burger for the Burgers & Sandwiches chapter", position: "center 54%" },
  "snacks": { src: "/site-media/snacks_d06704c0.jpg", alt: "A vibrant Indian street-snack spread for the Snacks chapter", position: "center 54%" },
  "rolls": { src: "/site-media/rolls_b8c7cd33.jpg", alt: "Paneer kathi rolls for the Rolls chapter", position: "center 54%" },
  "maggi": { src: "/site-media/maggi_05f531cb.webp", alt: "Street-style Maggi noodles for the Maggi chapter", position: "center 52%" },
  "accompaniments": { src: "/site-media/accompaniments_6b92232c.jpg", alt: "Raita and papad for the Accompaniments chapter", position: "center 54%" },
  "ice-creams": { src: "/manus-storage/desserts-ice-creams-chapter-hd_8d76f08d_6c11cac9.png", alt: "High-resolution ice cream from Naatures Scuup for the Desserts & Ice Creams chapter", position: "center 55%" },
  "drinks": { src: "/site-media/drinks_ecf68021.jpg", alt: "Colourful chilled mocktails for the Drinks & Shakes chapter", position: "center 52%" },
  "bakery-specials": { src: "/site-media/bakery-specials_6008eb2e.webp", alt: "Flaky paneer puff pastries for the Bakery Specials chapter", position: "center 52%" },
  "live-ice-creams": { src: "/manus-storage/naatures-scuup-live-ice-cream_cc0fddc0_60926744.jpg", alt: "Hand-rolled ice cream finished with fruit and chocolate for the Live Ice Creams chapter", position: "center 55%" },
  extras: { src: "/manus-storage/naatures-scuup-pizza-pasta_d2c371a3_70204bd5.jpg", alt: "Fresh pizza and creamy pasta beside table extras for the Extras chapter", position: "center 58%" },
};
