...
const chapterArtwork: Record<string, { src: string; alt: string; position: string }> = {
  ...
  "live-ice-creams": { src: "/manus-storage/naatures-scuup-live-ice-cream_cc0fddc0.jpg", alt: "Hand-rolled ice cream finished with fruit and chocolate for the Live Ice Creams chapter", position: "center 55%" },
  extras: { src: "/manus-storage/naatures-scuup-pizza-pasta_d2c371a3.jpg", alt: "Fresh pizza and creamy pasta beside table extras for the Extras chapter", position: "center 58%" },
};
